(function (root, factory) {
    ...
    function argon2Hash(params) {
        ...
        return scriptLoadedPromise.then(function() {
            ...
            var pwd = Module.allocate(intArrayFromString(params.pass), 'i8', Module.ALLOC_NORMAL);
            var pwdlen = params.pass.length;
            var salt = Module.allocate(intArrayFromString(params.salt), 'i8', Module.ALLOC_NORMAL);
