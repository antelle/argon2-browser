...
cp dist/argon2.wast.mappedGlobals dist/argon2.wasm.mappedGlobals
...
#    -DCMAKE_C_FLAGS="-O0" \
#    -DCMAKE_EXE_LINKER_FLAGS="-O0 -g4 -o dist/argon2-asm-debug.html --memory-init-file 0 -s NO_FILESYSTEM=1 -s 'EXPORTED_FUNCTIONS=[\"_argon2_hash\",\"_argon2_error_message\"]' -s DEMANGLE_SUPPORT=1 -s ASSERTIONS=1 -s NO_EXIT_RUNTIME=1 -s TOTAL_MEMORY=134217728 -s BINARYEN=0" && cmake --build . &&
